...
class WorkoutPageIndividual extends StatefulWidget {
  final int weeks;
  WorkoutPageIndividual({Key key, this.weeks}) : super(key: key);

  @override
  _WorkoutPageIndividualState createState() => _WorkoutPageIndividualState();
}

class _WorkoutPageIndividualState extends State<WorkoutPageIndividual> {
