...
class UsCLientsPlan extends StatefulWidget {
  @override
  _UsCLientsPlanState createState() => _UsCLientsPlanState();
}

class _UsCLientsPlanState extends State<UsCLientsPlan> {
  double width, height;
  @override
            ...
            child: Column(
              children: <Widget>[
                ...
                RaisedButton(
                  ...
                  onPressed: () {
                    //get in as corporate
                    Navigator.pushNamed(context, '/nri');
                  },
